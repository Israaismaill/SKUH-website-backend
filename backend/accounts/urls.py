...
from .views import RegisterView, EmailTokenObtainPairView, create_appointment, get_doctors, get_news ,get_appointments, create_doctor, update_doctor, delete_doctor
